...
// add tinySAK API
tsdp_api_add_js_scripts('head', './webRTC/js' + version + '/src/tinySAK/src/tsk_api.js');

tsdp_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header.js',
    ...
    './webRTC/js' + version + '/src/tinySDP/src/tsdp_message.js'
