...
if (!window.__b_release_mode) {
    tsdp_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header_A.js',
        './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header_C.js',
        './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header_M.js',
        './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header_O.js',
        './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
        './webRTC/js' + version + '/src/tinySDP/src/headers/tsdp_header_V.js'
    );
}