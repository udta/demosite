...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySIP/src/transactions/tsip_transac_ict.js',
        './webRTC/js' + version + '/src/tinySIP/src/transactions/tsip_transac_ist.js',
        './webRTC/js' + version + '/src/tinySIP/src/transactions/tsip_transac_layer.js',
        './webRTC/js' + version + '/src/tinySIP/src/transactions/tsip_transac_nict.js',
        './webRTC/js' + version + '/src/tinySIP/src/transactions/tsip_transac_nist.js'
    );
}