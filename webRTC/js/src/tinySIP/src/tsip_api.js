...
// add tinySAK API
tsip_api_add_js_scripts('head', './webRTC/js' + version + '/src/tinySAK/src/tsk_api.js');

// add tinyMEDIA API
tsip_api_add_js_scripts('head', './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_api.js');

// add tinySDP API
tsip_api_add_js_scripts('head', './webRTC/js' + version + '/src/tinySDP/src/tsdp_api.js');

// add tinySIP API
tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_action.js',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_event.js',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_message.js',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_session.js',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_stack.js',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_timers.js',
    './webRTC/js' + version + '/src/tinySIP/src/tsip_uri.js'
);
...
tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/authentication/tsip_auth.js',
    './webRTC/js' + version + '/src/tinySIP/src/authentication/tsip_challenge.js'
);

tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog.js',
    ...
    './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_layer.js'
...
tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header.js'
...
tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/parsers/tsip_parser_header.js'
...
tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/transactions/tsip_transac.js'
...
tsip_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinySIP/src/transports/tsip_transport.js',
    './webRTC/js' + version + '/src/tinySIP/src/transports/tsip_transport_layer.js'
);