...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_common.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_info.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_invite.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_message.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_options.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_publish.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_register.js',
        './webRTC/js' + version + '/src/tinySIP/src/api/tsip_api_subscribe.js'
    );
}