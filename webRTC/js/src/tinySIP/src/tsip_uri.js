...
function tsip_uri_strequals(s_s1, s_s2) {
    return (tsip_uri_strcmp(s_s1, s_s2, true) == 0);
}

function tsip_uri_striequals(s_s1, s_s2) {
    return (tsip_uri_strcmp(s_s1, s_s2, false) == 0);
}
...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySIP/src/parsers/tsip_parser_uri.js'
    );
}