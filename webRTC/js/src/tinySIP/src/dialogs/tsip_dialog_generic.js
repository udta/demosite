    ...
    if (o_self) {
        if (o_self.o_timerRefresh == o_timer) {
            switch (o_self.e_type) {
                case tsip_dialog_type_e.PUBLISH:
                    i_ret = o_self.fsm_act(tsip_dialog_generic_actions_e.O_PUBLISH, null, null);
                    break;
                case tsip_dialog_type_e.SUBSCRIBE:
                    i_ret = o_self.fsm_act(tsip_dialog_generic_actions_e.O_SUBSCRIBE, null, null);
                    break;
            }
...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_generic__message.js',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_generic__publish.js',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_generic__subscribe.js'
    );
}