...
function x0000_Connected_2_Connected_X_iINVITEorUPDATE(ao_args) {
	...
	*/
    ...
    // send the response
    if (!b_is_roap) {
        i_ret = o_dialog.send_response(o_request, 200, "OK", (o_dialog.o_msession_mgr && (b_force_sdp || b_bodiless_invite || o_dialog.o_msession_mgr.has_ro_changed() || o_dialog.o_msession_mgr.has_state_changed() || (e_old_media_type != e_new_media_type))));
    }
...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__client.js',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__ect.js',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__hold.js',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__server.js',
        './webRTC/js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__timers.js'
    );
}