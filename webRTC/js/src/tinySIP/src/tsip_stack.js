...
tsip_stack.prototype.SetProxyOutBoundUrl = function(s_url) {
    ...
    switch (ao_params[0]) {
        case "udp":
        default:
            e_tranport = tsip_transport_type_e.UDP;
            break;
        case "tcp":
            e_tranport = tsip_transport_type_e.TCP;
            break;
        case "tls":
            e_tranport = tsip_transport_type_e.TLS;
            break;
        case "dtls":
            e_tranport = tsip_transport_type_e.DTLS;
            break;
        case "sctp":
            e_tranport = tsip_transport_type_e.SCTP;
            break;
        case "ws":
            e_tranport = tsip_transport_type_e.WS;
            break;
        case "wss":
            e_tranport = tsip_transport_type_e.WSS;
            break;
    }
