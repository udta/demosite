...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Int.js', // 'Content-Length', 'Expires', 'Max-Forwards', 'Min_Expires', 'Min-SE', 'RSeq'
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_NameAddr.js', // 'From', 'To', 'Refer-To', 'Referred-By'
        ...
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Str.js', // Call-ID, 'Date', 'Event', 'P-Access-Network-Info', 'P-Charging-Function-Addresses', 'Server', SIP-ETag, SIP-If-Match, User-Agent, Warning, Dummy
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_StrArray.js', // 'Allow', 'Allow-Events', 'Privacy', 'Require', 'Supported'

        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Authorization.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Contact.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Content_Type.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_CSeq.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_RAck.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Refer_Sub.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Session_Expires.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Subscription_State.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_Via.js',
        './webRTC/js' + version + '/src/tinySIP/src/headers/tsip_header_WWW_Authenticate.js'
    );
}