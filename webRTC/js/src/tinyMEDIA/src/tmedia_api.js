...
tmedia_api_add_js_scripts('head',
    './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_common.js',
    //'src/tinyMEDIA/src/tmedia_defaults.js', #include_in<tmedia_common.js>
    './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_param.js',
    './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_qos.js'
