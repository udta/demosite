...
tmedia_session_mgr.prototype.set_ro = function(o_sdp, b_is_offer) {
    ...
    */
    ...
    if ((o_hdr_C = o_sdp.get_header(tsdp_header_type_e.C)) && o_hdr_C.s_addr) {
        b_is_loopback_address = (tsk_string_iequals("IP4", o_hdr_C.s_addrtype) && tsk_string_iequals("127.0.0.1", o_hdr_C.s_addr)) || (tsk_string_iequals("IP6", o_hdr_C.s_addrtype) && tsk_string_iequals("::1", o_hdr_C.s_addr));
    }
...
if (!window.__b_release_mode) {
    tmedia_api_add_js_scripts('head',
        './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_session_jsep.js',
        './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_session_roap.js',
        './webRTC/js' + version + '/src/tinyMEDIA/src/tmedia_session_ghost.js'
    );
}